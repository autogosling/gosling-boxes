...
echo python generate_specs.py -f train_specs/multi_layer_circular.json -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/multiple_view.json -pv -cm -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/simple_circular.json -pv -cm -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/single_cell_epi.json -pv -cm -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/three_composite_v.json -cm -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/three_composite.json -cm -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/two_by_two_sq_uneven_h.json -pv -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/two_by_two_uneven_h.json -pv -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/two_by_two_uneven_w.json -pv -s $SCALE -sw $SCALEWIDTH
echo python generate_specs.py -f train_specs/two_by_two.json -pv -cm -s $SCALE -sw $SCALEWIDTH
